...
using JakeGustafson;//Common.cs (not yet synchronized w/ JakeGustafson or other apps that may need to move methods to it (DigitalMusicMC has best of most versions) )
